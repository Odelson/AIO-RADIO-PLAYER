<?php
    ...
    $settings = $settings + $lang + array(
            ...
            'default_artwork' => getArtwork( null, null, $settings ),
            'og_image'        => ( ( empty( $settings[ 'fb_shareimg' ] ) ) ? $settings[ 'url' ] . getArtwork( null, null, $settings ) : $settings[ 'fb_shareimg' ] ),
            ...
            'json_settings'   => json_encode( ## Handle array which is passed to javascript for language and settings
                array(
                    ...
                    'channel'         => array(),
                    'title'           => strToUTF8( $settings[ 'title' ] ),
                    'artist_length'   => $settings[ 'artist_maxlength' ],
                    'title_length'    => $settings[ 'title_maxlength' ],
                    'default_artist'  => strToUTF8( $settings[ 'artist_default' ] ),
                    'default_title'   => strToUTF8( $settings[ 'title_default' ] ),
                    'default_channel' => strToUTF8( $settings[ 'default_channel' ] ),
