<?php
    ...
    class image {
        ...
        private function crop( $optimalWidth, $optimalHeight, $newWidth, $newHeight, $opt = array() ) {
            ...
            if ( ( !isset( $opt[ 'cropY' ] ) || $opt[ 'cropY' ] < 0 ) AND ( !isset( $opt[ 'cropX' ] ) || $opt[ 'cropX' ] < 0 ) ) {
         ...
         * @return string
         */
        public static function handle( $image, $size, $mode = null, $new_filename = null, $opt = array() ) {
