<?php
    ...
    class form {
        ...
        function add( $option = array() ) {
            ...
            if ( isset( $o[ 'size' ] ) ) $extras[] = 'maxlength="' . $o[ 'size' ] . '"';
            if ( isset( $o[ 'placeholder' ] ) ) $extras[] = 'placeholder="' . $o[ 'placeholder' ] . '"';
            if ( isset( $o[ 'required' ] ) ) $extras[] = 'required="' . $o[ 'required' ] . '"';
            if ( isset( $o[ 'reset' ] ) ) $extras[] = 'allowreset="true"';
            if ( isset( $o[ 'autocomplete' ] ) ) $extras[] = 'autocomplete="' . $o[ 'autocomplete' ] . '"';
            ...
            switch ( $o[ 'type' ] ) {
                ...
                case 'text':
                    $output .= '<div class="' . ( ( !empty( $o[ 'class' ] ) ) ? $o[ 'class' ] : '' ) . '">' .
                               '<input type="text" name="' . $o[ 'name' ] . '" class="form-control" id="' . $o[ 'name' ] . '" value="' . ( ( !empty( $_POST[ $o[ 'name' ] ] ) ) ? $_POST[ $o[ 'name' ] ] : '' ) . '"' . join( ' ', $extras ) . '></div>';
                    break;

                // Handle numberic inputs (HTML5+ thing)
                case 'number':
                    $output .= '<div class="' . ( ( !empty( $o[ 'class' ] ) ) ? $o[ 'class' ] : '' ) . '">' .
                               '<input type="number" name="' . $o[ 'name' ] . '" step="1" min="' . ( ( !isset( $o[ 'min' ] ) ) ? 0 : $o[ 'min' ] ) . '" max="' . ( ( !isset( $o[ 'max' ] ) ) ? '' : $o[ 'max' ] ) . '" ' .
                ...
                case 'password':
                    $output .= '<div class="' . ( ( !empty( $o[ 'class' ] ) ) ? $o[ 'class' ] : '' ) . '">' .
                               '<input type="password" name="' . $o[ 'name' ] . '" class="form-control" id="' . $o[ 'name' ] . '" value="' . ( ( !empty( $_POST[ $o[ 'name' ] ] ) ) ? $_POST[ $o[ 'name' ] ] : '' ) . '" autocomplete="off"' . join( ' ', $extras ) . '></div>';
                    break;
                ...
                case 'select':
                    ...
                    if ( is_array( $o[ 'options' ] ) ) {
                        foreach ( $o[ 'options' ] as $option => $value ) {
                            $output .= '<option' . ( ( ( ( !empty( $_POST[ $o[ 'name' ] ] ) ) ? $_POST[ $o[ 'name' ] ] : '' ) == $option ) ? ' value="' . $option . '" selected' : ' value="' . $option . '"' ) . '>' . $value . '</option>';
                        }
                    }
                ...
                case 'textarea':
                    $output .= '<div class="' . ( ( !empty( $o[ 'class' ] ) ) ? $o[ 'class' ] : '' ) . '">' .
                               '<textarea style="min-height: ' . ( ( isset( $o[ 'height' ] ) ) ? $o[ 'height' ] : '' ) . 'px;" name="' . $o[ 'name' ] . '" class="form-control" id="' . $o[ 'name' ] . '"' . join( ' ', $extras ) . '>' . ( ( !empty( $_POST[ $o[ 'name' ] ] ) ) ? $_POST[ $o[ 'name' ] ] : '' ) . '</textarea></div>';
                    break;

                // Handle checkboxes
                case 'checkbox':
                    $output .= '<div class="' . ( ( !empty( $o[ 'class' ] ) ) ? $o[ 'class' ] : '' ) . '">' .
                               '<div class="checkbox"><label><input type="checkbox" value="' . $o[ 'value' ] . '" name="' . $o[ 'name' ] . '" id="' . $o[ 'name' ] . '"' . ( ( isset( $_POST[ $o[ 'name' ] ] ) && $_POST[ $o[ 'name' ] ] == $o[ 'value' ] ) ? ' checked' : '' ) . '' . join( ' ', $extras ) . '>' .
                ...
                case 'static':
                    $output .= '<div class="' . $o[ 'class' ] . '"><p class="form-control-static">' . ( ( isset( $o[ 'name' ] ) && !empty( $_POST[ $o[ 'name' ] ] ) ) ? $_POST[ $o[ 'name' ] ] : '' ) . '</p></div>';
                    break;
