...
function txt( text, permanent ) {
    ...
    if ( permanent == true || typeof(aio[ 'txt-status' ]) == 'undefined' ) { aio[ 'txt-status' ] = text; }
    ...
    if ( permanent == null ) { aio[ 'txtobj' ] = setTimeout( function() { status.hide().html( aio[ 'txt-status' ] ).fadeIn( 'slow' ); }, 2000 ); }
