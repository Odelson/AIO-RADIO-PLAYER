    ...
    <div class="content">
        ...
        <?php
            ...
            if ( !isset( $_GET[ 'add' ] ) AND empty( $_GET[ 'edit' ] ) ) {
                    ...
                    <table class="table hover">
                        ...
                        <?php
                            ...
                            foreach ( $files as $file ) {
                                ...
                                echo '<tr><td class="col-sm-9"><b>' . $language[ extDel( $file ) ] . '</b> (' . strtoupper( extDel( $file ) ) . ')</td>' .
                                     '<td><a class="btn btn-primary btn-small" href="?s=lang&edit=' . extDel( $file ) . '"><i class="fa fa-edit"></i> Edit</a> ' . ( ( $file != 'en.php' ) ?
                                        '<a class="btn btn-danger btn-small" onclick="return confirm(\'Are you sure?\');" href="?s=lang&del=' . extDel( $file ) . '"><i class="fa fa-times"></i> Delete</a>' : '' ) . '</td></tr>';
                ...
                echo $f->add( array( 'label' => 'Back', 'placeholder' => 'Back', 'name' => 'ui-back', 'reset' => true ) );
