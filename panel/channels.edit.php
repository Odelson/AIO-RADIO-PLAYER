<?php
    ...
    if ( !empty( $_GET[ 'logo' ] ) AND $_GET[ 'logo' ] == 'delete' ) {
    ...
    if ( isset( $_POST[ 'submit' ] ) ) {
        ...
        if ( empty( $_POST[ 'name' ] ) ) {
            ...
            if ( !empty( $_FILES[ 'logo' ][ 'tmp_name' ] ) ) {
                ...
                if ( !is_array( $up ) ) {
                ...
                } else if ( !in_array( extGet( $up[ 'path' ] ), $logo_ext ) ) {
                    ...
                    if ( extGet( $up[ 'path' ] ) != 'svg' ) { // Only resize if not SVG
            ...
            for ( $i = 0; $i <= $c; $i++ ) {
                ...
                for ( $f = 0; $f <= $totalFields; $f++ ) {
                    ...
                    } else if ( in_array( extGet( $_POST[ $name ][ $f ] ), $streamUrlExt ) ) { // Check if stream URL is a playlist
    ...
    <div class="panel">
        <div class="content">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input class="form-control" type="text" name="name" id="name" value="<?php echo htmlentities( ( ( !empty( $_POST[ 'name' ] ) ) ? $_POST[ 'name' ] : '' ), null, 'utf-8' ); ?>" placeholder="Rock channel">
                </div>
            </div>
                    ...
                    <select class="form-control" name="skin" id="skin">
                        ...
                        <?php
                            ...
                            if ( is_array( $custom ) && count( $custom ) >= 1 )
                                foreach ( $custom as $file ) : $list[ ucfirst( extDel( $file ) ) ] = "custom/{$file}"; endforeach;

                            // Now show and pick used
                            if ( count( $list ) >= 1 ) {
                                foreach ( $list as $key => $file ) {
                                    $vv = ( ( isset( $_GET[ 'e' ] ) AND $_GET[ 'e' ] !== 'add' AND $channels[ $_GET[ 'e' ] ][ 'skin' ] == $file ) ? ' selected' : '' );
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" value="true" name="show-time" id="showtime"<?php echo ( ( isset( $_POST[ 'show-time' ] ) AND $_POST[ 'show-time' ] == 'true' ) ) ? 'checked' : ''; ?>>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="qualitylist">
                        ...
                        <?php
                            ...
                            if ( isset( $_POST[ 'quality' ] ) AND is_array( $_POST[ 'quality' ] ) ) {
                    ...
                    <select class="form-control" name="stats" id="stats">
                        <?php
                            ...
                            foreach ( $values as $key => $row ) {
                                ...
                                if ( isset( $_POST[ 'stats' ] ) AND $_POST[ 'stats' ] == $key ) $key .= '" selected="selected';
