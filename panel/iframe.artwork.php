...
<html>
    ...
    <body>
        <?php
            ...
            if ( ob_get_status() ) while ( @ob_end_flush() ) ;
                ...
                if ( !is_dir( "./../{$_GET[ 'path' ]}" ) ) {
                    ...
                    if ( !is_array( $import ) OR count( $import ) < 1 ) {
                        ...
                        foreach ( $import as $file ) {
                            ...
                            if ( !in_array( extGet( $file ), $allow_ext ) ) {
                                ...
                                // New file name & path
                                $new_file = "{$lock_local}/tmp/images/" . parseTrack( basename( $file ) );
                ...
                if ( $handle = @opendir( "{$_GET['path']}" ) ) {
                    ...
                    while ( false !== ( $file = readdir( $handle ) ) ) {
                        ...
                        if ( !in_array( extGet( $file ), $allow_ext ) ) {
                            ...
                            // New file name & path
                            $new_file     = "./../tmp/images/" . parseTrack( basename( $file ) );
